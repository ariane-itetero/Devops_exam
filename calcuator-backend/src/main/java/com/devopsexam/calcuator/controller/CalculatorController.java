package com.devopsexam.calcuator.controller;



import com.devopsexam.calcuator.dto.Equation;
import com.devopsexam.calcuator.service.CalculatorService;
...
public class CalculatorController implements CalculatorService {
    ...
    public ResponseEntity<Equation> add(@RequestParam(value = "param1", required = true) String param1,
        ...
        try {
            return ResponseEntity.ok(CalculatorService.add(Double.parseDouble(param1), Double.parseDouble(param2)));
        } catch (Exception e) {
    ...
    public ResponseEntity<Equation> subtract(@RequestParam(value = "param1", required = true) String param1,
                                             @RequestParam(value = "param2", required = true) String param2) {
        try {
            return ResponseEntity.ok(CalculatorService.subtract(Double.parseDouble(param1), Double.parseDouble(param2)));
        } catch (Exception e) {
            return new ResponseEntity<Equation>(new Equation("-"), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<Equation> multiply(@RequestParam(value = "param1", required = true) String param1,
                                             @RequestParam(value = "param2", required = true) String param2) {
        try {
            return ResponseEntity.ok(CalculatorService.multiply(Double.parseDouble(param1), Double.parseDouble(param2)));
        } catch (Exception e) {
            return new ResponseEntity<Equation>(new Equation("*"), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<Equation> divide(@RequestParam(value = "param1", required = true) String param1,
        ...
        try {
            ...
            return ResponseEntity.ok(CalculatorService.divide(Double.parseDouble(param1), Double.parseDouble(param2)));
        } catch (Exception e) {
            return new ResponseEntity<Equation>(new Equation("/"), HttpStatus.BAD_REQUEST);
        }
    }
